...
![CircularRegression hex logo](../../assets/packages/circularregression-logo.svg){.package-logo}
:::

## Visual preview

The image below comes from the package material and illustrates a relationship between observed directions in the Noshiro data.

![Circular scatterplot for the Noshiro data.](../../assets/packages/circularregression-noshiro.png){.package-example}
