...
![DonutMap hex logo](../../assets/packages/donutmap-logo.svg){.package-logo}
:::
...
![Example DonutMap map with curved links coloured by corridor.](../../assets/packages/donutmap-example.png){.package-example}
