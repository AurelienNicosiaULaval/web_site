...
::: {.g-col-12 .g-col-lg-4 .news-panel}
### ggcircular sur CRAN
Le package R `ggcircular` est disponible sur le CRAN depuis le 4 juin 2026 en version 0.1.0. Il étend `ggplot2` aux données circulaires, axiales et directionnelles.
