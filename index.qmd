...
::: {.g-col-12 .g-col-lg-4 .news-panel}
### DonutMap et ggcircular sur CRAN
Les packages R `DonutMap` et `ggcircular` sont disponibles sur le CRAN depuis juin 2026. Ils soutiennent respectivement la cartographie de diagrammes en anneau et la visualisation de données circulaires.
