...
| `MQT-2101` | Quarto course site for applied data analysis and statistical modelling. | `quarto`, `teaching`, `statistics-education`, `data-science-education`, `statistical-modeling` | `https://aureliennicosiaulaval.github.io/MQT-2101/` |
...
| `Modele_etude_de_cas` | learnr template for reproducible interactive case studies. | `r`, `learnr`, `learnr-tutorial`, `teaching`, `statistics-education`, `reproducible-research` | `https://aureliennicosiaulaval.github.io/site_ressources_SSD/` |
