...
Les informations CRAN ci-dessous ont été vérifiées le 11 juin 2026.
...
<div class="package-card-meta">Compendium R • v0.0.0.9000</div>
</div>
</div>
...
Contribution au package R `amt` avec le PR `#142`, “Add generative validation diagnostics”, mergé le 23 juin 2026 dans `jmsigner/amt`.
