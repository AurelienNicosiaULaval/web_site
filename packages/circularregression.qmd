...
![](../assets/packages/circularregression-logo.svg){fig-alt="Logo hexagonal CircularRegression" fig-cap="Logo hexagonal CircularRegression" .package-logo}
:::
...
![](../assets/packages/circularregression-bison-fit-fr.png){fig-alt="Illustration d’un ajustement CircularRegression sur des directions de mouvement de bisons." fig-cap="Illustration d’un ajustement CircularRegression sur des directions de mouvement de bisons." .package-example}
