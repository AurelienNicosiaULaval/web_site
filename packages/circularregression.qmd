...
L’image ci-dessous provient du matériel du package et illustre une relation entre directions observées dans les données de Noshiro.

![Nuage de points circulaires pour les données de Noshiro.](../assets/packages/circularregression-noshiro.png){.package-example}
